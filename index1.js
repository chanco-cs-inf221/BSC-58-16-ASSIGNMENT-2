...
function addWork(){
        ...
        startingDate:document.getElementById("startingWork").value,
		completionDate:document.getElementById("completionWork").value,
    };

    if(work.organizationName!==""&&work.description!==""){
